...
else if (document.form2.pollutant.selectedIndex == '4' || document.form2.pollutant.selectedIndex == '5' || document.form2.pollutant.selectedIndex == '6' || form.pollutant.selectedIndex == '7' || form.pollutant.selectedIndex == '8')
{
...
if (document.form2.outputbox3.value == 'Good')
{
	...
	else if (document.form2.pollutant.selectedIndex == '4' || form.pollutant.selectedIndex == '5')
	{
		document.form2.TextSensitive.value="People with asthma are the group most at risk.";
	}
	else if (document.form2.pollutant.selectedIndex == '6' || form.pollutant.selectedIndex == '7')
	{
